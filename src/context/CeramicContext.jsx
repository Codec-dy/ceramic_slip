...
const CeramicContext = (props) => {
    ...
    const [user, setUser] = useState({name:'', email:'', phone:'', state:'', street:'',city:'',"zipCode":'', date:'', shipping:'', totalCost:0});
    ...
    const [edit,setEdit] = useState({name:'', email:'', phone:'', state:'', street:'',city:'', date:'', shipping:'',shippingCost:0, totalCost:0,boxs:0,Code:''});
